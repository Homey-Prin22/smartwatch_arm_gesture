...
### Apple
*TODO* This directory will contain the project for data acquisition from Apple devices. The project will be built using Kotlin Multiplatform Mobile (KMM) and will access the gyroscope and accelerometer sensors on Apple Watch. The collected data will be sent to the API server for processing.
